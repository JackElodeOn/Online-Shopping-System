...
CREATE TABLE `online_shopping_commodity`  (
                                              ...
                                              FOREIGN KEY (`creator_user_id`) REFERENCES online_shopping_user(user_id),
...
CREATE TABLE `online_shopping_order`  (
                                          ...
                                          FOREIGN KEY (`commodity_id`) REFERENCES online_shopping_commodity(commodity_id),
                                          FOREIGN KEY (`user_id`) REFERENCES online_shopping_user(user_id),
